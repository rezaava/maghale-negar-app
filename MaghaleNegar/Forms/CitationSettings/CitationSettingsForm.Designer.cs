...
namespace MaghaleNegar.Forms.CitationSettings
{
    partial class CitationSettingsForm
    {
        ...
        private void InitializeComponent(Document doc,DedicatedFunctions.AccessType accessType)
        {
            ...
            this.citationSettingsControl = new MaghaleNegar.Forms.CitationSettings.CitationSettingsControl(doc, accessType);
            this.SuspendLayout();
            // 
            // timerOpenAnimation
            // 
